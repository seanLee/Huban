...
- (UIBarButtonItem *)backButton {
    ...
    if ([temporaryBarButtonItem respondsToSelector:@selector(setTitleTextAttributes:forState:)]){
        textAttributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:kBackButtonFontSize],
                           NSForegroundColorAttributeName: [UIColor whiteColor],
                           };
        [[UIBarButtonItem appearance] setTitleTextAttributes:textAttributes forState:UIControlStateNormal];
        UIImage *backButtonBackIameg = [[UIImage imageNamed:@"backButtonBackImage"] resizableImageWithCapInsets:UIEdgeInsetsMake(16, 16, 0, 0)];
        [[UIBarButtonItem appearance] setBackButtonBackgroundImage:backButtonBackIameg forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
    }
