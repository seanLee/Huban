...
- (UITapImageView *)getHeaderViewWithStr:(NSString *)headerStr andHeight:(CGFloat)height andBlock:(void(^)(id obj))tapAction {
    return [self getHeaderViewWithStr:headerStr andHeight:height color:SYSBACKGROUNDCOLOR_DEFAULT andBlock:tapAction];
}

- (UITapImageView *)getHeaderViewWithStr:(NSString *)headerStr andHeight:(CGFloat)height color:(UIColor *)color andBlock:(void(^)(id obj))tapAction {
    UITapImageView *headerView = [[UITapImageView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, height)];
    [headerView setImage:[UIImage imageWithColor:color]];
    
    UILabel *headerLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 0, kScreen_Width-20.f, CGRectGetHeight(headerView.frame))];
