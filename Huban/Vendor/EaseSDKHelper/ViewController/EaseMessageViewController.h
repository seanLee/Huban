...
@interface EaseMessageViewController : EaseRefreshTableViewController<IChatManagerDelegate, IEMChatProgressDelegate, EMCallManagerCallDelegate, EMCDDeviceManagerDelegate, UIMessageInputViewDelegate,QBImagePickerControllerDelegate>
